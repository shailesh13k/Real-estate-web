...
[![GitHub last commit](https://img.shields.io/github/last-commit/shailesh13k/Real-Estate-website.svg?style=flat-square)](https://github.com/shailesh13k/Real-Estate-website/commit/master) ![Supported platforms](https://img.shields.io/badge/platform-Windows-informational.svg?style=flat-square) ![GitHub top language](https://img.shields.io/github/languages/top/shailesh13k/Real-Estate-website) 
...
If you are new to Django, checkout the [Django 2.x Cheat Sheet](https://github.com/shailesh13k/Real-Estate-Django-Web-App/blob/master/django_cheat_sheet.md)

If you want to deploy this Web App In Ubuntu 18.04 Server, Please Follow this [Guide](https://github.com/shailesh13k/Real-Estate-Django-Web-App/blob/master/Django_Deployment_to_Ubuntu_18.04.md) 
...
```sh
git clone https://github.com/shailesh13k/
Real-Estate-website.git
```
